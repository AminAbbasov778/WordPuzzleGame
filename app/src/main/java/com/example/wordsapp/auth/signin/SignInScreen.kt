            ...
            if (state.isLoading) {
                ...
                Column(modifier = Modifier.verticalScroll(rememberScrollState())
                    ...
                    Box(contentAlignment = Alignment.CenterStart) {
                        ...
                        BasicTextField(
                            value = state.email,
                            onValueChange = { onIntent(SignInIntent.EnterEmail(it)) },
                            modifier = Modifier
                    ...
                    Box(contentAlignment = Alignment.CenterStart) {
                        ...
                        BasicTextField(
                            ...
                            onValueChange = { onIntent(SignInIntent.EnterPassword(it)) },
                            modifier = Modifier
                                .padding(horizontal = 20.dp)
                                .fillMaxWidth()
                                .height(50.dp)
                                ...
                                Row(
                                    ...
                                    Icon(
                                        ...
                                        modifier = Modifier
                                            ...
                                            .clickable {
                                                onIntent(SignInIntent.ChangePasswordVisibility)
                    ...
                    Box(
                        modifier = Modifier
                            ...
                            .heightIn(48.dp)
                            .background(
                                color = if (state.email.isNotEmpty() && state.password.isNotEmpty()) Color(
                                    0xFFC50000
                    ...
                    Box(
                        modifier = Modifier
                            ...
                            .border(
                                ...
                                onIntent(SignInIntent.ContinueAsGuest)
                            }
                    ) {
                        Text(
